...
- VueJs tem duas versões que permitem criar componentes de forma diferente. Nó podemos criar templates no "Vue puro" fazendo algo como **Vue.component('nome-componente')**
...
- Não podemos usar a instancia como componente (colocando o id em dois lugares diferentes) pois o **el** vai parar sempre no primeiro que encontrar. Por isso eles diponibilizam como uma das formas o **Vue.component('nome-componente')**.
